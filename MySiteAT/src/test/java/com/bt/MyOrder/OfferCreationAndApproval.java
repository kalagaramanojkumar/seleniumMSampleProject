...
public class OfferCreationAndApproval {
    WebDriver driver;
    ...
    public String orderNameValue = "ICR_BAUOVQ_MNJ_AutomatedOffer";
    ...
    public void customerSearch() throws InterruptedException {
        ...
        if(searchResult.isDisplayed()) {
            ...
            if (customerNameResultField.isDisplayed() && customerNameResultField.getText().contains(customerName)) {
                ...
                try {
                    salesChannel = driver.findElement(By.xpath("//td[@title='BTGS UK']"));
                } catch (Exception e) {
...
//                                    System.out.println("WindowsNames :"+windowsNames);
                                    ...
                                    WebElement offerRadioBtn = driver.findElement(By.xpath("(//div[@id='srhOffr_radio'])[1]"));
                                    offerRadioBtn.click();

                                    Thread.sleep(3000);

                                    if(offerRadioBtn.isSelected()){

                                        WebElement searchDropDown = driver.findElement(By.xpath("//div[@aria-label='Quote ID']"));
                                        searchDropDown.click();
                                        Thread.sleep(2000);

                                        WebElement offerNameDropDownValue = driver.findElement(By.xpath("//li[@aria-label='Offer Name']"));
                                        Thread.sleep(2000);
                                        offerNameDropDownValue.click();

                                        WebElement searchOfferTextBox = driver.findElement(By.xpath("//input[@id='searchParam']"));
                                        Thread.sleep(2000);
                                        searchOfferTextBox.sendKeys(friendlyOfferNameValue);
                                        Thread.sleep(2500);
                                        WebElement searchOfferBtn = driver.findElement(By.xpath("//button[@class='search-button']"));
                                        searchOfferBtn.click();

                                        Thread.sleep(5000);

                                        WebElement approveOfferBtn = driver.findElement(By.xpath("//tw-tableaction[@title='Approve Offer']//button[@class='t-component t-table-action t-clickable']"));
                                        approveOfferBtn.click();
                                        Thread.sleep(7000);

                                        WebElement createNewOrderBtn = driver.findElement(By.xpath("(//button[@id='Button_LQ3RQQC5NCAA0OQX4'])[1]"));
                                        createNewOrderBtn.click();
                                        Thread.sleep(7000);
                                        WebElement orderName = driver.findElement(By.xpath("//input[@id='orderName']"));

                                        orderName.sendKeys(orderNameValue);
                                        Thread.sleep(2000);
